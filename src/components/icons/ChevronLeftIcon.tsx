...
// Left-pointing chevron — the right chevron mirrored via a flip transform.
// currentColor so the consumer's text color controls the fill. The back
// affordance in the secondary nav.
export const ChevronLeftIcon = ({ className }: ChevronLeftIconProps) => (
  <svg width="18" height="20" viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className={className}>
