...
/**
 * Order-scoped `/edit/shipping`. Same UI as the checkout ShippingAddressCheckoutPage
 * (minus the funnel progress bar), wired to the patient's current order. Back always
 * returns to the current-order page.
 */
export const OrderShippingEditPage = ({
  ...
  const {
    ...
    destinationZip,
  } = useOrderShippingEdit({ initialView });
