...
const COPY: Record<ComparisonTheme, {
  ...
  sildenafil: {
    ...
    accent: "#056cb6",
    brand: { src: "/images/comparison/viagra.png", w: 203, h: 147, label: "Viagra" },
    generic: { src: "/images/comparison/sildenafil.png", w: 270, h: 270, label: "Sildenafil" },
    para1:
  ...
  tadalafil: {
    ...
    accent: "#CD8F24",
    brand: { src: "/images/comparison/cialis.png", w: 249, h: 147, label: "Cialis" },
    generic: { src: "/images/comparison/tadalafil.png", w: 269, h: 168, label: "Tadalafil" },
    para1:
...
const DesktopCard = ({ side, accent }: { side: SideImage; accent: string }) => (
  <div className="flex min-h-[269px] w-[230px] flex-col overflow-hidden rounded-[10px] border border-[#BFD9E4]">
    <div className="flex flex-1 items-center justify-center p-5">
      <Image
        ...
        width={side.w}
        height={side.h}
        className="h-auto max-h-[120px] w-auto max-w-[75%] object-contain"
      />
    </div>
...
export const BrandComparisonSection = ({ theme = "sildenafil", className }: BrandComparisonSectionProps) => {
  ...
  return (
    <section className={cn("bg-white", className)}>
      <div className="mx-auto flex max-w-[1180px] flex-col items-start gap-10 px-[18px] py-10 md:flex-row md:justify-between md:gap-12 md:px-6 md:py-[100px]">
          ...
          <div className="mt-6 w-full md:hidden">
            <div className="flex h-24 overflow-hidden rounded-[10px]">
              <div className="flex flex-1 items-center justify-center">
                <Image src={copy.brand.src} alt={copy.brand.label} width={copy.brand.w} height={copy.brand.h} className="h-16 w-auto object-contain" />
              </div>
            ...
            <div className="flex h-24 overflow-hidden rounded-[10px]">
              ...
              <div className="flex flex-1 items-center justify-center bg-white">
                <Image src={copy.generic.src} alt={copy.generic.label} width={copy.generic.w} height={copy.generic.h} className="h-16 w-auto object-contain" />
              </div>
            </div>
          </div>
